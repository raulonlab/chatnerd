...
class LLMFactory:
    ...
    def get_embedding_function(self) -> Embeddings:
        ...
        if provider == "huggingface":
            ...
            try:
                # Add default settings for sentence-transformers 3.x
                ...
                logging.error(f"Error initializing HuggingFaceEmbeddings: {str(e)}")
                raise
    ...
    def get_summarize_model(self) -> Tuple[BaseLanguageModel, str]:
        ...
        match llm_provider:
            case "ollama":
                ...
                if is_chat:
                    ...
                    llm = OllamaLLM(**selected_model_config)
            case "openai":
                # standarize model, model_id, model_name
